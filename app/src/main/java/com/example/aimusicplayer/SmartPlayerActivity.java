...
public class SmartPlayerActivity extends AppCompatActivity
{
    ...
    private void validateReceiveValueAndStartPlaying()
    {
        ...
        mSongsNme = mySongs.get(position).getName();
    ...
    private void playNextSong()
    {
        ...
        mSongsNme = mySongs.get(position).toString();
        songNameTxt.setText(mSongsNme);
        myMediaPlayer.start();
